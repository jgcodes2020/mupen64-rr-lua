...
static INSTSETOP OpInstructionSet[1 << 6] = {
    // bit31-26
    INSTSETOP_SPECIAL, INSTSETOP_REGIMM, INSTSETOP_MAIN,  INSTSETOP_MAIN,  INSTSETOP_MAIN,  INSTSETOP_MAIN,
    INSTSETOP_MAIN,    INSTSETOP_MAIN,   INSTSETOP_MAIN,  INSTSETOP_MAIN,  INSTSETOP_MAIN,  INSTSETOP_MAIN,
    INSTSETOP_MAIN,    INSTSETOP_MAIN,   INSTSETOP_MAIN,  INSTSETOP_MAIN,  INSTSETOP_COP0,  INSTSETOP_COP1,
    INSTSETOP_UNDEF,   INSTSETOP_UNDEF,  INSTSETOP_MAIN,  INSTSETOP_MAIN,  INSTSETOP_MAIN,  INSTSETOP_MAIN,
    INSTSETOP_MAIN,    INSTSETOP_MAIN,   INSTSETOP_MAIN,  INSTSETOP_MAIN,  INSTSETOP_UNDEF, INSTSETOP_UNDEF,
    INSTSETOP_UNDEF,   INSTSETOP_UNDEF,  INSTSETOP_MAIN,  INSTSETOP_MAIN,  INSTSETOP_MAIN,  INSTSETOP_MAIN,
    INSTSETOP_MAIN,    INSTSETOP_MAIN,   INSTSETOP_MAIN,  INSTSETOP_MAIN,  INSTSETOP_MAIN,  INSTSETOP_MAIN,
    INSTSETOP_MAIN,    INSTSETOP_MAIN,   INSTSETOP_MAIN,  INSTSETOP_MAIN,  INSTSETOP_MAIN,  INSTSETOP_MAIN,
    INSTSETOP_MAIN,    INSTSETOP_MAIN,   INSTSETOP_UNDEF, INSTSETOP_UNDEF, INSTSETOP_MAIN,  INSTSETOP_MAIN,
    INSTSETOP_UNDEF,   INSTSETOP_MAIN,   INSTSETOP_MAIN,  INSTSETOP_MAIN,  INSTSETOP_UNDEF, INSTSETOP_UNDEF,
...
static INSTSETCOP0 Cop0InstructionSet[1 << 5] = {
    INSTSETCOP0_MAIN,  INSTSETCOP0_MAIN,  INSTSETCOP0_MAIN,  INSTSETCOP0_UNDEF, INSTSETCOP0_MAIN,  INSTSETCOP0_MAIN,
    INSTSETCOP0_MAIN,  INSTSETCOP0_UNDEF, INSTSETCOP0_BC0,   INSTSETCOP0_UNDEF, INSTSETCOP0_UNDEF, INSTSETCOP0_UNDEF,
    INSTSETCOP0_UNDEF, INSTSETCOP0_UNDEF, INSTSETCOP0_UNDEF, INSTSETCOP0_UNDEF, INSTSETCOP0_TLB,   INSTSETCOP0_UNDEF,
    INSTSETCOP0_UNDEF, INSTSETCOP0_UNDEF, INSTSETCOP0_UNDEF, INSTSETCOP0_UNDEF, INSTSETCOP0_UNDEF, INSTSETCOP0_UNDEF,
    INSTSETCOP0_UNDEF, INSTSETCOP0_UNDEF, INSTSETCOP0_UNDEF, INSTSETCOP0_UNDEF, INSTSETCOP0_UNDEF, INSTSETCOP0_UNDEF,
...
static INSTSETCOP1 Cop1InstructionSet[1 << 5] = {
    INSTSETCOP1_MAIN,  INSTSETCOP1_MAIN,  INSTSETCOP1_MAIN,  INSTSETCOP1_UNDEF, INSTSETCOP1_MAIN,  INSTSETCOP1_MAIN,
    INSTSETCOP1_MAIN,  INSTSETCOP1_UNDEF, INSTSETCOP1_BC1,   INSTSETCOP1_UNDEF, INSTSETCOP1_UNDEF, INSTSETCOP1_UNDEF,
    INSTSETCOP1_UNDEF, INSTSETCOP1_UNDEF, INSTSETCOP1_UNDEF, INSTSETCOP1_UNDEF, INSTSETCOP1_S,     INSTSETCOP1_D,
    INSTSETCOP1_UNDEF, INSTSETCOP1_UNDEF, INSTSETCOP1_W,     INSTSETCOP1_L,     INSTSETCOP1_UNDEF, INSTSETCOP1_UNDEF,
    INSTSETCOP1_UNDEF, INSTSETCOP1_UNDEF, INSTSETCOP1_UNDEF, INSTSETCOP1_UNDEF, INSTSETCOP1_UNDEF, INSTSETCOP1_UNDEF,
    INSTSETCOP1_UNDEF, INSTSETCOP1_UNDEF,
};
static INST Cop1Instruction[1 << 5] = {
    INST_MFC1,  INST_DMFC1, INST_CFC1,  INST_UNDEF, INST_MTC1,  INST_DMTC1, INST_CTC1,  INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF,
};
...
static INST SInstruction[1 << 6] = {
    INST_ADD_S,    INST_SUB_S,     INST_MUL_S,     INST_DIV_S,    INST_SQRT_S,    INST_ABS_S,     INST_MOV_S,
    INST_NEG_S,    INST_ROUND_L_S, INST_TRUNC_L_S, INST_CEIL_L_S, INST_FLOOR_L_S, INST_ROUND_W_S, INST_TRUNC_W_S,
    INST_CEIL_W_S, INST_FLOOR_W_S, INST_UNDEF,     INST_UNDEF,    INST_UNDEF,     INST_UNDEF,     INST_UNDEF,
    INST_UNDEF,    INST_UNDEF,     INST_UNDEF,     INST_UNDEF,    INST_UNDEF,     INST_UNDEF,     INST_UNDEF,
    INST_UNDEF,    INST_UNDEF,     INST_UNDEF,     INST_UNDEF,    INST_UNDEF,     INST_CVT_D_S,   INST_UNDEF,
    INST_UNDEF,    INST_CVT_W_S,   INST_CVT_L_S,   INST_UNDEF,    INST_UNDEF,     INST_UNDEF,     INST_UNDEF,
    INST_UNDEF,    INST_UNDEF,     INST_UNDEF,     INST_UNDEF,    INST_UNDEF,     INST_UNDEF,     INST_C_F_S,
    INST_C_UN_S,   INST_C_EQ_S,    INST_C_UEQ_S,   INST_C_OLT_S,  INST_C_ULT_S,   INST_C_OLE_S,   INST_C_ULE_S,
    INST_C_SF_S,   INST_C_NGLE_S,  INST_C_SEQ_S,   INST_C_NGL_S,  INST_C_LT_S,    INST_C_NGE_S,   INST_C_LE_S,
    INST_C_NGT_S,
};
static INST DInstruction[1 << 6] = {
    INST_ADD_D,    INST_SUB_D,     INST_MUL_D,     INST_DIV_D,    INST_SQRT_D,    INST_ABS_D,     INST_MOV_D,
    INST_NEG_D,    INST_ROUND_L_D, INST_TRUNC_L_D, INST_CEIL_L_D, INST_FLOOR_L_D, INST_ROUND_W_D, INST_TRUNC_W_D,
    INST_CEIL_W_D, INST_FLOOR_W_D, INST_UNDEF,     INST_UNDEF,    INST_UNDEF,     INST_UNDEF,     INST_UNDEF,
    INST_UNDEF,    INST_UNDEF,     INST_UNDEF,     INST_UNDEF,    INST_UNDEF,     INST_UNDEF,     INST_UNDEF,
    INST_UNDEF,    INST_UNDEF,     INST_UNDEF,     INST_UNDEF,    INST_CVT_S_D,   INST_UNDEF,     INST_UNDEF,
    INST_UNDEF,    INST_CVT_W_D,   INST_CVT_L_D,   INST_UNDEF,    INST_UNDEF,     INST_UNDEF,     INST_UNDEF,
    INST_UNDEF,    INST_UNDEF,     INST_UNDEF,     INST_UNDEF,    INST_UNDEF,     INST_UNDEF,     INST_C_F_D,
    INST_C_UN_D,   INST_C_EQ_D,    INST_C_UEQ_D,   INST_C_OLT_D,  INST_C_ULT_D,   INST_C_OLE_D,   INST_C_ULE_D,
    INST_C_SF_D,   INST_C_NGLE_D,  INST_C_SEQ_D,   INST_C_NGL_D,  INST_C_LT_D,    INST_C_NGE_D,   INST_C_LE_D,
    INST_C_NGT_D,
};
...
const INSTFMT InstFormat[INST_COUNT] = {
    ...
    INSTF_ADDRR,   INSTF_ADDRR,   INSTF_ADDRR,   INSTF_ADDRR,   INSTF_ADDRR,   INSTF_ADDRR,   INSTF_ADDRR,
    INSTF_ADDRR,   INSTF_ADDRR,   INSTF_ADDRR,   INSTF_ADDRR,   INSTF_ADDRR,   INSTF_ADDRR,   INSTF_ADDRW,
    INSTF_ADDRW,   INSTF_ADDRW,   INSTF_ADDRW,   INSTF_ADDRW,   INSTF_ADDRW,   INSTF_ADDRW,   INSTF_ADDRW,
    INSTF_ADDRW,   INSTF_ADDRW,   INSTF_NONE,

    INSTF_R3,      INSTF_ISIGN,   INSTF_ISIGN,   INSTF_R3,      INSTF_R3,      INSTF_IUNSIGN, INSTF_R3,
    INSTF_ISIGN,   INSTF_ISIGN,   INSTF_R3,      INSTF_R2,      INSTF_R2,      INSTF_R2,      INSTF_R2,
    INSTF_R2,      INSTF_R2,      INSTF_SA,      INSTF_SA,      INSTF_R3,      INSTF_SA,      INSTF_SA,
    INSTF_R3,      INSTF_SA,      INSTF_SA,      INSTF_R3,      INSTF_R3,      INSTF_R3,      INSTF_LUI,
    INSTF_R1,      INSTF_R1,      INSTF_R1,      INSTF_R1,      INSTF_R2,      INSTF_R2,      INSTF_R3,
    INSTF_R3,      INSTF_IUNSIGN, INSTF_SA,      INSTF_R3,      INSTF_R3,      INSTF_ISIGN,   INSTF_IUNSIGN,
    INSTF_R3,      INSTF_SA,      INSTF_R3,      INSTF_SA,      INSTF_R3,      INSTF_R3,      INSTF_R3,
    INSTF_R3,      INSTF_IUNSIGN,

    INSTF_2BRANCH, INSTF_2BRANCH, INSTF_1BRANCH, INSTF_1BRANCH, INSTF_1BRANCH, INSTF_1BRANCH, INSTF_1BRANCH,
    INSTF_1BRANCH, INSTF_1BRANCH, INSTF_1BRANCH, INSTF_1BRANCH, INSTF_1BRANCH, INSTF_1BRANCH, INSTF_1BRANCH,
    INSTF_2BRANCH, INSTF_2BRANCH, INSTF_J,       INSTF_J,       INSTF_R2,      INSTF_JR,

    INSTF_NONE,    INSTF_NONE,

    INSTF_LFR,     INSTF_LFR,     INSTF_LFW,     INSTF_LFW,

    INSTF_NONE,    INSTF_NONE,    INSTF_NONE,    INSTF_NONE,    INSTF_NONE,    INSTF_NONE,    INSTF_NONE,
    INSTF_NONE,    INSTF_NONE,    INSTF_NONE,    INSTF_NONE,    INSTF_NONE,    INSTF_NONE,    INSTF_NONE,
    INSTF_MFC0,    INSTF_MTC0,    INSTF_NONE,    INSTF_NONE,    INSTF_NONE,    INSTF_NONE,

    INSTF_MFC1,    INSTF_MFC1,    INSTF_MTC1,    INSTF_MTC1,    INSTF_MTC1,    INSTF_MTC1,    INSTF_0BRANCH,
    INSTF_0BRANCH, // BC1F‚Æ‚©‚æ‚­‚í‚©‚Á‚Ä‚È‚¢
    INSTF_0BRANCH, INSTF_0BRANCH,

    INSTF_R3F,     INSTF_R3F,     INSTF_R3F,     INSTF_R3F,     INSTF_R2F,     INSTF_R2F,     INSTF_R2F,
    INSTF_R2F,     INSTF_R2F,     INSTF_R2F,     INSTF_R2F,     INSTF_R2F,     INSTF_R2F,     INSTF_R2F,
    INSTF_R2F,     INSTF_R2F,     INSTF_R2F,     INSTF_R2F,     INSTF_R2F,

    INSTF_C,       INSTF_C,       INSTF_C,       INSTF_C,       INSTF_C,       INSTF_C,       INSTF_C,
    INSTF_C,       INSTF_C,       INSTF_C,       INSTF_C,       INSTF_C,       INSTF_C,       INSTF_C,
    INSTF_C,       INSTF_C,
...
const char *const OpecodeName[INST_COUNT] = {
    ...
    "lb",        "lbu",      "ld",        "ldl",       "ldr",       "lh",       "lhu",       "ll",      "lld",
    "lw",        "lwl",      "lwr",       "lwu",       "sb",        "sc",       "scd",       "sd",      "sdl",
    "sdr",       "sh",       "sw",        "swl",       "swr",       "sync",

    "add",       "addi",     "addiu",     "addu",      "and",       "andi",     "dadd",      "daddi",   "daddiu",
    "daddu",     "ddiv",     "ddivu",     "div",       "divu",      "dmult",    "dmultu",    "dsll",    "dsll32",
    "dsllv",     "dsra",     "dsra32",    "dsrav",     "dsrl",      "dsrl32",   "dsrlv",     "dsub",    "dsubu",
    "lui",       "mfhi",     "mflo",      "mthi",      "mtlo",      "mult",     "multu",     "nor",     "or",
    "ori",       "sll",      "sllv",      "slt",       "slti",      "sltiu",    "sltu",      "sra",     "srav",
    "srl",       "srlv",     "sub",       "subu",      "xor",       "xori",

    "beq",       "beql",     "bgez",      "bgezal",    "bgezall",   "bgezl",    "bgtz",      "bgtzl",   "blez",
    "blezl",     "bltz",     "bltzal",    "bltzall",   "bltzl",     "bne",      "bnel",      "j",       "jal",
    "jalr",      "jr",
    ...
    "tltu",      "tne",      "tnei",      "cache",     "eret",      "mfc0",     "mtc0",      "tlbp",    "tlbr",
    "tlbwi",     "tlbwr",

    "mfc1",      "dmfc1",    "cfc1",      "mtc1",      "dmtc1",     "ctc1",     "bc1f",      "bc1t",    "bc1fl",
    "bc1tl",

    "add.s",     "sub.s",    "mul.s",     "div.s",     "sqrt.s",    "abs.s",    "mov.s",     "neg.s",   "round.l.s",
    "trunc.l.s", "ceil.l.s", "floor.l.s", "round.w.s", "trunc.w.s", "ceil.w.s", "floor.w.s", "cvt.d.s", "cvt.w.s",
    "cvt.l.s",

    "c.f.s",     "c.un.s",   "c.eq.s",    "c.ueq.s",   "c.olt.s",   "c.ult.s",  "c.ole.s",   "c.ule.s", "c.sf.s",
    "c.ngle.s",  "c.seq.s",  "c.ngl.s",   "c.lt.s",    "c.nge.s",   "c.le.s",   "c.ngt.s",

    "add.d",     "sub.d",    "mul.d",     "div.d",     "sqrt.d",    "abs.d",    "mov.d",     "neg.d",   "round.l.d",
    "trunc.l.d", "ceil.l.d", "floor.l.d", "round.w.d", "trunc.w.d", "ceil.w.d", "floor.w.d", "cvt.s.d", "cvt.w.d",
    "cvt.l.d",
...
const INSTFTYPE InstFormatType[INSTF_COUNT] = {
    INSTFTYPE_NONE, INSTFTYPE_I, INSTFTYPE_I, INSTFTYPE_I,  INSTFTYPE_I,  INSTFTYPE_I,  INSTFTYPE_I,  INSTFTYPE_I,
    INSTFTYPE_I,    INSTFTYPE_I, INSTFTYPE_J, INSTFTYPE_R,  INSTFTYPE_R,  INSTFTYPE_R,  INSTFTYPE_R,  INSTFTYPE_R,
    INSTFTYPE_R,    INSTFTYPE_R, INSTFTYPE_R, INSTFTYPE_LF, INSTFTYPE_LF, INSTFTYPE_CF, INSTFTYPE_CF, INSTFTYPE_CF};
void (*InstFormatTypeFunc[INSTFTYPE_COUNT])(uint32_t, INSTOPERAND *) = {noneType, iType, jType, rType, lfType, cfType};
...
const char *const COP0RegisterName[32] = {
    "index",      "random",     "entrylo0", "entrylo1", "context",  "pagemask",   "wired",      "reserved07",
    ...
    "reserved24", "reserved25", "perr",     "cacheerr", "taglo",    "taghi",      "errorepc",   "reserved1f"};
