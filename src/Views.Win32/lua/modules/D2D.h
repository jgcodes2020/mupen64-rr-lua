...
luaL_checknumber(L, idx + 6))
    ...
    static int draw_text(lua_State* L)
    {
        ...
        if (!lua->rctx.dw_text_layouts.contains(params_hash))
        {
            ...
            g_io_service.string_to_wstring(font_name).c_str(),
            nullptr,
            ...
            auto wtext = g_io_service.string_to_wstring(text);
    ...
    static int measure_text(lua_State* L)
    {
        ...
        std::wstring text = g_io_service.string_to_wstring(std::string(luaL_checkstring(L, 1)));
    ...
    static int load_image(lua_State* L)
    {
        ...
        g_io_service.string_to_wstring(path).c_str(),
        NULL,
        GENERIC_READ,
