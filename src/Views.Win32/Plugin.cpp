...
void load_gfx(HMODULE handle)
{
    ...
    gfx_info.rom = g_core_ctx->rom;
    gfx_info.rdram = (uint8_t*)g_core_ctx->rdram;
    gfx_info.dmem = (uint8_t*)g_core_ctx->SP_DMEM;
    gfx_info.imem = (uint8_t*)g_core_ctx->SP_IMEM;
    gfx_info.mi_intr_reg = &g_core_ctx->MI_register->mi_intr_reg;
    gfx_info.dpc_start_reg = &g_core_ctx->dpc_register->dpc_start;
    gfx_info.dpc_end_reg = &g_core_ctx->dpc_register->dpc_end;
    gfx_info.dpc_current_reg = &g_core_ctx->dpc_register->dpc_current;
    gfx_info.dpc_status_reg = &g_core_ctx->dpc_register->dpc_status;
    gfx_info.dpc_clock_reg = &g_core_ctx->dpc_register->dpc_clock;
    gfx_info.dpc_bufbusy_reg = &g_core_ctx->dpc_register->dpc_bufbusy;
    gfx_info.dpc_pipebusy_reg = &g_core_ctx->dpc_register->dpc_pipebusy;
    gfx_info.dpc_tmem_reg = &g_core_ctx->dpc_register->dpc_tmem;
    gfx_info.vi_status_reg = &g_core_ctx->vi_register->vi_status;
    gfx_info.vi_origin_reg = &g_core_ctx->vi_register->vi_origin;
    gfx_info.vi_width_reg = &g_core_ctx->vi_register->vi_width;
    gfx_info.vi_intr_reg = &g_core_ctx->vi_register->vi_v_intr;
    gfx_info.vi_v_current_line_reg = &g_core_ctx->vi_register->vi_current;
    gfx_info.vi_timing_reg = &g_core_ctx->vi_register->vi_burst;
    gfx_info.vi_v_sync_reg = &g_core_ctx->vi_register->vi_v_sync;
    gfx_info.vi_h_sync_reg = &g_core_ctx->vi_register->vi_h_sync;
    gfx_info.vi_leap_reg = &g_core_ctx->vi_register->vi_leap;
    gfx_info.vi_h_start_reg = &g_core_ctx->vi_register->vi_h_start;
    gfx_info.vi_v_start_reg = &g_core_ctx->vi_register->vi_v_start;
    gfx_info.vi_v_burst_reg = &g_core_ctx->vi_register->vi_v_burst;
    gfx_info.vi_x_scale_reg = &g_core_ctx->vi_register->vi_x_scale;
    gfx_info.vi_y_scale_reg = &g_core_ctx->vi_register->vi_y_scale;
...
void load_input(uint16_t version, HMODULE handle)
{
    ...
    control_info.header = g_core_ctx->rom;
...
void load_audio(HMODULE handle)
{
    ...
    audio_info.rom = g_core_ctx->rom;
    audio_info.rdram = (uint8_t*)g_core_ctx->rdram;
    audio_info.dmem = (uint8_t*)g_core_ctx->SP_DMEM;
    audio_info.imem = (uint8_t*)g_core_ctx->SP_IMEM;
    audio_info.mi_intr_reg = &dummy_dw;
    audio_info.ai_dram_addr_reg = &g_core_ctx->ai_register->ai_dram_addr;
    audio_info.ai_len_reg = &g_core_ctx->ai_register->ai_len;
    audio_info.ai_control_reg = &g_core_ctx->ai_register->ai_control;
    audio_info.ai_status_reg = &dummy_dw;
    audio_info.ai_dacrate_reg = &g_core_ctx->ai_register->ai_dacrate;
    audio_info.ai_bitrate_reg = &g_core_ctx->ai_register->ai_bitrate;
...
void load_rsp(HMODULE handle)
{
    ...
    rsp_info.rdram = (uint8_t*)g_core_ctx->rdram;
    rsp_info.dmem = (uint8_t*)g_core_ctx->SP_DMEM;
    rsp_info.imem = (uint8_t*)g_core_ctx->SP_IMEM;
    rsp_info.mi_intr_reg = &g_core_ctx->MI_register->mi_intr_reg;
    rsp_info.sp_mem_addr_reg = &g_core_ctx->sp_register->sp_mem_addr_reg;
    rsp_info.sp_dram_addr_reg = &g_core_ctx->sp_register->sp_dram_addr_reg;
    rsp_info.sp_rd_len_reg = &g_core_ctx->sp_register->sp_rd_len_reg;
    rsp_info.sp_wr_len_reg = &g_core_ctx->sp_register->sp_wr_len_reg;
    rsp_info.sp_status_reg = &g_core_ctx->sp_register->sp_status_reg;
    rsp_info.sp_dma_full_reg = &g_core_ctx->sp_register->sp_dma_full_reg;
    rsp_info.sp_dma_busy_reg = &g_core_ctx->sp_register->sp_dma_busy_reg;
    rsp_info.sp_pc_reg = &g_core_ctx->rsp_register->rsp_pc;
    rsp_info.sp_semaphore_reg = &g_core_ctx->sp_register->sp_semaphore_reg;
    rsp_info.dpc_start_reg = &g_core_ctx->dpc_register->dpc_start;
    rsp_info.dpc_end_reg = &g_core_ctx->dpc_register->dpc_end;
    rsp_info.dpc_current_reg = &g_core_ctx->dpc_register->dpc_current;
    rsp_info.dpc_status_reg = &g_core_ctx->dpc_register->dpc_status;
    rsp_info.dpc_clock_reg = &g_core_ctx->dpc_register->dpc_clock;
    rsp_info.dpc_bufbusy_reg = &g_core_ctx->dpc_register->dpc_bufbusy;
    rsp_info.dpc_pipebusy_reg = &g_core_ctx->dpc_register->dpc_pipebusy;
    rsp_info.dpc_tmem_reg = &g_core_ctx->dpc_register->dpc_tmem;
...
void setup_dummy_info()
{
    ...
    dummy_gfx_info.rdram = (uint8_t*)g_core_ctx->rdram;
    dummy_gfx_info.dmem = (uint8_t*)g_core_ctx->SP_DMEM;
    dummy_gfx_info.imem = (uint8_t*)g_core_ctx->SP_IMEM;
    dummy_gfx_info.mi_intr_reg = &g_core_ctx->MI_register->mi_intr_reg;
    dummy_gfx_info.dpc_start_reg = &g_core_ctx->dpc_register->dpc_start;
    dummy_gfx_info.dpc_end_reg = &g_core_ctx->dpc_register->dpc_end;
    dummy_gfx_info.dpc_current_reg = &g_core_ctx->dpc_register->dpc_current;
    dummy_gfx_info.dpc_status_reg = &g_core_ctx->dpc_register->dpc_status;
    dummy_gfx_info.dpc_clock_reg = &g_core_ctx->dpc_register->dpc_clock;
    dummy_gfx_info.dpc_bufbusy_reg = &g_core_ctx->dpc_register->dpc_bufbusy;
    dummy_gfx_info.dpc_pipebusy_reg = &g_core_ctx->dpc_register->dpc_pipebusy;
    dummy_gfx_info.dpc_tmem_reg = &g_core_ctx->dpc_register->dpc_tmem;
    dummy_gfx_info.vi_status_reg = &g_core_ctx->vi_register->vi_status;
    dummy_gfx_info.vi_origin_reg = &g_core_ctx->vi_register->vi_origin;
    dummy_gfx_info.vi_width_reg = &g_core_ctx->vi_register->vi_width;
    dummy_gfx_info.vi_intr_reg = &g_core_ctx->vi_register->vi_v_intr;
    dummy_gfx_info.vi_v_current_line_reg = &g_core_ctx->vi_register->vi_current;
    dummy_gfx_info.vi_timing_reg = &g_core_ctx->vi_register->vi_burst;
    dummy_gfx_info.vi_v_sync_reg = &g_core_ctx->vi_register->vi_v_sync;
    dummy_gfx_info.vi_h_sync_reg = &g_core_ctx->vi_register->vi_h_sync;
    dummy_gfx_info.vi_leap_reg = &g_core_ctx->vi_register->vi_leap;
    dummy_gfx_info.vi_h_start_reg = &g_core_ctx->vi_register->vi_h_start;
    dummy_gfx_info.vi_v_start_reg = &g_core_ctx->vi_register->vi_v_start;
    dummy_gfx_info.vi_v_burst_reg = &g_core_ctx->vi_register->vi_v_burst;
    dummy_gfx_info.vi_x_scale_reg = &g_core_ctx->vi_register->vi_x_scale;
    dummy_gfx_info.vi_y_scale_reg = &g_core_ctx->vi_register->vi_y_scale;
    ...
    dummy_audio_info.rdram = (uint8_t*)g_core_ctx->rdram;
    dummy_audio_info.dmem = (uint8_t*)g_core_ctx->SP_DMEM;
    dummy_audio_info.imem = (uint8_t*)g_core_ctx->SP_IMEM;
    dummy_audio_info.mi_intr_reg = &g_core_ctx->MI_register->mi_intr_reg;
    dummy_audio_info.ai_dram_addr_reg = &g_core_ctx->ai_register->ai_dram_addr;
    dummy_audio_info.ai_len_reg = &g_core_ctx->ai_register->ai_len;
    dummy_audio_info.ai_control_reg = &g_core_ctx->ai_register->ai_control;
    dummy_audio_info.ai_status_reg = &g_core_ctx->ai_register->ai_status;
    dummy_audio_info.ai_dacrate_reg = &g_core_ctx->ai_register->ai_dacrate;
    dummy_audio_info.ai_bitrate_reg = &g_core_ctx->ai_register->ai_bitrate;
    ...
    dummy_rsp_info.rdram = (uint8_t*)g_core_ctx->rdram;
    dummy_rsp_info.dmem = (uint8_t*)g_core_ctx->SP_DMEM;
    dummy_rsp_info.imem = (uint8_t*)g_core_ctx->SP_IMEM;
    dummy_rsp_info.mi_intr_reg = &g_core_ctx->MI_register->mi_intr_reg;
    dummy_rsp_info.sp_mem_addr_reg = &g_core_ctx->sp_register->sp_mem_addr_reg;
    dummy_rsp_info.sp_dram_addr_reg = &g_core_ctx->sp_register->sp_dram_addr_reg;
    dummy_rsp_info.sp_rd_len_reg = &g_core_ctx->sp_register->sp_rd_len_reg;
    dummy_rsp_info.sp_wr_len_reg = &g_core_ctx->sp_register->sp_wr_len_reg;
    dummy_rsp_info.sp_status_reg = &g_core_ctx->sp_register->sp_status_reg;
    dummy_rsp_info.sp_dma_full_reg = &g_core_ctx->sp_register->sp_dma_full_reg;
    dummy_rsp_info.sp_dma_busy_reg = &g_core_ctx->sp_register->sp_dma_busy_reg;
    dummy_rsp_info.sp_pc_reg = &g_core_ctx->rsp_register->rsp_pc;
    dummy_rsp_info.sp_semaphore_reg = &g_core_ctx->sp_register->sp_semaphore_reg;
    dummy_rsp_info.dpc_start_reg = &g_core_ctx->dpc_register->dpc_start;
    dummy_rsp_info.dpc_end_reg = &g_core_ctx->dpc_register->dpc_end;
    dummy_rsp_info.dpc_current_reg = &g_core_ctx->dpc_register->dpc_current;
    dummy_rsp_info.dpc_status_reg = &g_core_ctx->dpc_register->dpc_status;
    dummy_rsp_info.dpc_clock_reg = &g_core_ctx->dpc_register->dpc_clock;
    dummy_rsp_info.dpc_bufbusy_reg = &g_core_ctx->dpc_register->dpc_bufbusy;
    dummy_rsp_info.dpc_pipebusy_reg = &g_core_ctx->dpc_register->dpc_pipebusy;
    dummy_rsp_info.dpc_tmem_reg = &g_core_ctx->dpc_register->dpc_tmem;
