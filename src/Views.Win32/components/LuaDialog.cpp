...
static void create_placeholder_dialog(t_dialog_state& dlg)
{
    ...
    dlg.placeholder_hwnd = CreateDialog(g_main_ctx.app_instance, MAKEINTRESOURCE(IDD_LUA_INSTANCE_PLACEHOLDER), dlg.mgr_hwnd, nullptr);
                ...
                case LBN_SELCHANGE:
                    {
                        ...
                        g_dlg.inst_hwnd = CreateDialogParam(g_main_ctx.app_instance, MAKEINTRESOURCE(IDD_LUA_INSTANCE), hwnd, lua_instance_dialog_proc, (LPARAM)param);
...
void LuaDialog::show()
{
    ...
    CreateDialog(g_main_ctx.app_instance, MAKEINTRESOURCE(IDD_LUA_MANAGER), g_main_ctx.main_hwnd, lua_manager_dialog_proc);
